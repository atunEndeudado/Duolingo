  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Algo falló de nuestro lado. Probá refrescar o volver al inicio.
        </p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "tuboLingo — Aprendé idiomas con XP y rachas" },
      {
        name: "description",
        content:
          "Plataforma de aprendizaje de idiomas: cursos por nivel, lecciones en orden, XP, racha diaria, insignias y rankings.",
      },
